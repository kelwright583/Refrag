...
import { upsertRepairAssessmentSchema } from '@/lib/validation/assessment'

type Params = { params: Promise<{ assessmentId: string }> }

/** PUT /api/assessments/[assessmentId]/repair */
export async function PUT(request: NextRequest, { params }: Params) {
  try {
    ...
    const parsed = upsertRepairAssessmentSchema.safeParse(body)
