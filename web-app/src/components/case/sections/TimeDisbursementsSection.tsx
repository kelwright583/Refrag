                    ...
                    <tr key={entry.id} className="hover:bg-slate-50/50">
                      ...
                      <td className="py-2">
                        <div className="flex items-center justify-end gap-1">
                          <button onClick={() => handleEditTime(entry)} className="p-1 text-slate hover:text-copper rounded">
                            <span className="sr-only">Edit</span>
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>
                          </button>
                          <button onClick={() => handleDeleteTime(entry.id)} className="p-1 text-slate hover:text-red-500 rounded">
                            <X className="w-3 h-3" />
                          </button>
                        </div>
                      </td>
                ...
                <tbody className="divide-y divide-[#D4CFC7]/50">
                  {disbEntries.map(entry => (
                    <tr key={entry.id} className="hover:bg-slate-50/50">
                      ...
                      <td className="py-2">
                        <div className="flex items-center justify-end gap-1">
                          <button onClick={() => handleEditDisb(entry)} className="p-1 text-slate hover:text-copper rounded">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>
                          </button>
                          <button onClick={() => handleDeleteDisb(entry.id)} className="p-1 text-slate hover:text-red-500 rounded">
                            <X className="w-3 h-3" />
                          </button>
                        </div>
                      </td>
