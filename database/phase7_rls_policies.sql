...
-- Depends on helper functions from rls_policies.sql: is_org_member(), is_org_admin(), is_staff()
-- ============================================================================
...
DROP POLICY IF EXISTS "motor_assessments_select" ON motor_assessments;
CREATE POLICY "motor_assessments_select" ON motor_assessments
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "motor_assessments_insert" ON motor_assessments;
CREATE POLICY "motor_assessments_insert" ON motor_assessments
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "motor_assessments_update" ON motor_assessments;
CREATE POLICY "motor_assessments_update" ON motor_assessments
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "motor_assessments_delete" ON motor_assessments;
CREATE POLICY "motor_assessments_delete" ON motor_assessments
  FOR DELETE USING (is_org_admin(org_id));

DROP POLICY IF EXISTS "motor_assessments_staff_select" ON motor_assessments;
...
DROP POLICY IF EXISTS "vehicle_details_select" ON vehicle_details;
CREATE POLICY "vehicle_details_select" ON vehicle_details
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "vehicle_details_insert" ON vehicle_details;
CREATE POLICY "vehicle_details_insert" ON vehicle_details
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "vehicle_details_update" ON vehicle_details;
CREATE POLICY "vehicle_details_update" ON vehicle_details
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "vehicle_details_delete" ON vehicle_details;
...
DROP POLICY IF EXISTS "tyre_details_select" ON tyre_details;
CREATE POLICY "tyre_details_select" ON tyre_details
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "tyre_details_insert" ON tyre_details;
CREATE POLICY "tyre_details_insert" ON tyre_details
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "tyre_details_update" ON tyre_details;
CREATE POLICY "tyre_details_update" ON tyre_details
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "tyre_details_delete" ON tyre_details;
...
DROP POLICY IF EXISTS "pre_existing_damages_select" ON pre_existing_damages;
CREATE POLICY "pre_existing_damages_select" ON pre_existing_damages
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "pre_existing_damages_insert" ON pre_existing_damages;
CREATE POLICY "pre_existing_damages_insert" ON pre_existing_damages
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "pre_existing_damages_update" ON pre_existing_damages;
CREATE POLICY "pre_existing_damages_update" ON pre_existing_damages
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "pre_existing_damages_delete" ON pre_existing_damages;
...
DROP POLICY IF EXISTS "repair_assessments_select" ON repair_assessments;
CREATE POLICY "repair_assessments_select" ON repair_assessments
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "repair_assessments_insert" ON repair_assessments;
CREATE POLICY "repair_assessments_insert" ON repair_assessments
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "repair_assessments_update" ON repair_assessments;
CREATE POLICY "repair_assessments_update" ON repair_assessments
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "repair_assessments_delete" ON repair_assessments;
...
DROP POLICY IF EXISTS "parts_assessments_select" ON parts_assessments;
CREATE POLICY "parts_assessments_select" ON parts_assessments
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "parts_assessments_insert" ON parts_assessments;
CREATE POLICY "parts_assessments_insert" ON parts_assessments
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "parts_assessments_update" ON parts_assessments;
CREATE POLICY "parts_assessments_update" ON parts_assessments
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "parts_assessments_delete" ON parts_assessments;
...
DROP POLICY IF EXISTS "claim_financials_select" ON claim_financials;
CREATE POLICY "claim_financials_select" ON claim_financials
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "claim_financials_insert" ON claim_financials;
CREATE POLICY "claim_financials_insert" ON claim_financials
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "claim_financials_update" ON claim_financials;
CREATE POLICY "claim_financials_update" ON claim_financials
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "claim_financials_delete" ON claim_financials;
...
DROP POLICY IF EXISTS "assessment_documents_select" ON assessment_documents;
CREATE POLICY "assessment_documents_select" ON assessment_documents
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "assessment_documents_insert" ON assessment_documents;
CREATE POLICY "assessment_documents_insert" ON assessment_documents
  FOR INSERT WITH CHECK (is_org_member(org_id));

DROP POLICY IF EXISTS "assessment_documents_update" ON assessment_documents;
CREATE POLICY "assessment_documents_update" ON assessment_documents
  FOR UPDATE USING (is_org_member(org_id));

DROP POLICY IF EXISTS "assessment_documents_delete" ON assessment_documents;
...
DROP POLICY IF EXISTS "assessment_settings_select" ON assessment_settings;
CREATE POLICY "assessment_settings_select" ON assessment_settings
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "assessment_settings_insert" ON assessment_settings;
CREATE POLICY "assessment_settings_insert" ON assessment_settings
  FOR INSERT WITH CHECK (is_org_admin(org_id));

DROP POLICY IF EXISTS "assessment_settings_update" ON assessment_settings;
CREATE POLICY "assessment_settings_update" ON assessment_settings
  FOR UPDATE USING (is_org_admin(org_id));

DROP POLICY IF EXISTS "assessment_settings_delete" ON assessment_settings;
...
DROP POLICY IF EXISTS "approved_repairers_select" ON approved_repairers;
CREATE POLICY "approved_repairers_select" ON approved_repairers
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "approved_repairers_insert" ON approved_repairers;
CREATE POLICY "approved_repairers_insert" ON approved_repairers
  FOR INSERT WITH CHECK (is_org_admin(org_id));

DROP POLICY IF EXISTS "approved_repairers_update" ON approved_repairers;
CREATE POLICY "approved_repairers_update" ON approved_repairers
  FOR UPDATE USING (is_org_admin(org_id));

DROP POLICY IF EXISTS "approved_repairers_delete" ON approved_repairers;
...
DROP POLICY IF EXISTS "preferred_parts_suppliers_select" ON preferred_parts_suppliers;
CREATE POLICY "preferred_parts_suppliers_select" ON preferred_parts_suppliers
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "preferred_parts_suppliers_insert" ON preferred_parts_suppliers;
CREATE POLICY "preferred_parts_suppliers_insert" ON preferred_parts_suppliers
  FOR INSERT WITH CHECK (is_org_admin(org_id));

DROP POLICY IF EXISTS "preferred_parts_suppliers_update" ON preferred_parts_suppliers;
CREATE POLICY "preferred_parts_suppliers_update" ON preferred_parts_suppliers
  FOR UPDATE USING (is_org_admin(org_id));

DROP POLICY IF EXISTS "preferred_parts_suppliers_delete" ON preferred_parts_suppliers;
...
DROP POLICY IF EXISTS "report_versions_select" ON report_versions;
CREATE POLICY "report_versions_select" ON report_versions
  FOR SELECT USING (is_org_member(org_id));

DROP POLICY IF EXISTS "report_versions_insert" ON report_versions;
CREATE POLICY "report_versions_insert" ON report_versions
  FOR INSERT WITH CHECK (is_org_member(org_id));

-- No update/delete on report_versions — they are immutable snapshots

DROP POLICY IF EXISTS "report_versions_staff_select" ON report_versions;
